...
export default function FAQ() {
  ...
  return (
    ...
    <section className="bg-[#fafaf7] min-h-screen">
      ...
      {/* HERO SECTION */}
      <div className="bg-gradient-to-r from-[#edf7df] to-[#f8f8f1] py-20 border-b border-[#e5e7db]">
        ...
        <span>›</span>
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-[#5f7a5f] font-medium mb-4 tracking-wide uppercase">
              Frequently Asked Questions
            </p>

            <h1 className="text-[52px] leading-[1.1] font-bold text-[#163616]">
            ...
            <p className="mt-7 text-[18px] leading-[1.9] text-[#4b5563] max-w-2xl">
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8 py-20">
        ...
        <div className="space-y-6">
          ...
          {faqData.map((faq, index) => (
            ...
            <details
              key={index}
              className="group bg-white rounded-[24px] border border-[#ebefe3] shadow-sm overflow-hidden transition"
            >

              <summary className="flex items-center justify-between cursor-pointer list-none px-8 py-7">

                <h2 className="text-[22px] font-semibold text-[#183818] pr-8">
                  {faq.question}
                </h2>

                <div className="min-w-[42px] h-[42px] rounded-full bg-[#edf7df] flex items-center justify-center text-[#2d5a2d] text-2xl font-light group-open:rotate-45 transition duration-300">
                  +
                </div>
              ...
              <div className="px-8 pb-8">
                ...
                <div className="h-[1px] bg-[#eef2e6] mb-6"></div>

                <p className="text-[17px] leading-[1.9] text-[#4b5563]">
                  {faq.answer}
                </p>
        ...
        {/* SUPPORT BOX */}
        <div className="mt-20 bg-gradient-to-r from-[#0d3b0d] to-[#145214] rounded-[32px] p-10 lg:p-14 text-white relative overflow-hidden">

          <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">

            <div>

              <p className="text-[#d4e7c7] uppercase tracking-widest text-sm mb-4">
                Need More Help?
              </p>

              <h2 className="text-[42px] leading-[1.2] font-bold">

                Still Have Questions?

              </h2>

              <p className="mt-5 text-[#e5efe0] text-[17px] leading-[1.9] max-w-2xl">
            ...
            <div className="flex flex-wrap gap-5">
              ...
              <Link className="border border-white hover:bg-white hover:text-[#1d4d1d] transition px-8 py-4 rounded-2xl font-semibold text-lg" to="/contact" onClick={() => window.scrollTo(0, 0)}>
                 Contact Us
                </Link>

              <button className="border border-white hover:bg-white hover:text-[#1d4d1d] transition px-8 py-4 rounded-2xl font-semibold text-lg">
